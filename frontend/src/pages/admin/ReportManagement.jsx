  ...
  switch (status) {
    ...
    case "rejected":
      return (
        ...
        >
          <XOctagon className="w-3 h-3 ml-1" /> مرفوض
        </span>
      );
    default:
      return (
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-500 mt-2">
            مراجعة وتصنيف وحل البلاغات المقدمة من المستخدمين حول المنشورات،
            الصفقات، أو الحسابات.
          </p>
        </header>
        ...
        <div className="bg-white p-6 shadow-xl rounded-2xl border border-gray-100">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">
            البلاغات التي تحتاج إلى مراجعة (
          ...
          {reports.length === 0 && !isLoading ? (
            <p className="text-gray-500 p-4 text-center border-2 border-dashed border-gray-200 rounded-lg">
              لا توجد بلاغات حالياً في النظام.
            </p>
          ) : (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {reports.map((report) => (
                    ...
                    >
                      ...
                      <td
                        className="px-6 py-4 max-w-xs truncate text-sm text-gray-700"
                        title={report.reason}
                      >
                        {report.reason}
                      </td>
