  ...
  switch (status) {
    case "pending":
      return (
        ...
        >
          <Clock className="w-3 h-3 ml-1" /> بانتظار الرد
        </span>
      );
    case "processing":
      return (
    ...
    case "completed":
      return (
        ...
        >
          <CheckCircle className="w-3 h-3 ml-1" /> مكتملة
        </span>
      );
    case "cancelled":
      return (
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-500 mt-2">
            مراجعة الصفقات النشطة (العروض المقبولة) وإدارة حالتها يدوياً في
            حالات الضرورة أو النزاع.
          </p>
        </header>
        ...
        <div className="bg-white p-6 shadow-xl rounded-2xl border border-gray-100">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">
            الصفقات النشطة (
            {
              deals.filter(
                (d) =>
                  d.dealStatus === "pending" || d.dealStatus === "processing",
              ).length
            }
            )
          </h2>
          ...
          {deals.length === 0 && !isLoading ? (
            <p className="text-gray-500 p-4 text-center border-2 border-dashed border-gray-200 rounded-lg">
              لا توجد صفقات حالياً في النظام.
            </p>
          ) : (
