  ...
  const handleConfirm = async () => {
    ...
    try {
      if (actionType === "SUSPEND") {
        ...
        await ownerService.overrideRoleChange(
          selectedUser.id,
          targetRole,
          reason,
        );
            ...
            <tbody className="divide-y divide-neutral-800">
              {users.map((u) => (
                ...
                >
                  ...
                  <td className="p-4">
                    {u.isActive ? (
                      <span className="text-green-500 text-xs font-bold px-2 py-1 bg-green-900/20 rounded">
                        {t("status.active")}
                      </span>
                    ) : (
                      <span className="text-red-500 text-xs font-bold px-2 py-1 bg-red-900/20 rounded">
                        {t("status.suspended")}
                      </span>
                    )}
                  </td>
            ...
            <div className="p-6 border-b border-neutral-800 flex justify-between items-center bg-neutral-950 rounded-t-xl">
              <div>
                ...
                <p className="text-xs text-neutral-500 font-mono">
                  TARGET: {selectedUser.id} ({selectedUser.email})
                </p>
              </div>
              ...
              <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-1/3 p-6 border-r border-neutral-800 space-y-6 bg-neutral-950 overflow-auto">
                  <div className="p-4 bg-neutral-900 rounded border border-neutral-800 text-xs text-neutral-400">
                    This action overrides standard system policy. You must
                    provide a valid reason and verify the impact before
                    confirming.
                  </div>

                  {actionType === "ROLE" && (
                    <div>
                      <label className="block text-xs font-bold text-neutral-400 mb-2 uppercase">
                        New Role
                      </label>
                      <select
                  ...
                  <div>
                    ...
                    />
                    <div className="text-right text-[10px] text-neutral-600 mt-1">
                ...
                <div className="w-2/3 bg-black flex flex-col relative">
                  {!previewTrace ? (
                    <div className="flex-1 flex items-center justify-center text-neutral-600 italic p-10 text-center">
                      Enter justification and click Verify Impact to load the
                      Policy Trace.
                    </div>
                  ) : (
                    <div className="flex-1 flex flex-col overflow-hidden">
                      ...
                      <div className="bg-neutral-900 border-b border-neutral-800 p-6 space-y-2 shrink-0">
                        <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-2 border-l-2 border-red-500 pl-3">
                          Executive Summary
                        </h4>
                        <ul className="text-xs space-y-1.5 text-neutral-300 list-disc pl-4">
                          <li>
                            ...
                            <strong className="text-red-400">
                              {previewTrace.decision || "DENY"}
                            </strong>{" "}
                            (Standard Rules).
                          </li>
                          <li>
                            Intervention: You are explicitly{" "}
                            <strong className="text-white">forcing</strong> a
                            state change to{" "}
                            <strong className="text-white">{actionType}</strong>
                            .
                          </li>
                          <li>
                            Documentation: Your ID, Reason, and this Trace will
                            be{" "}
                      ...
                      <div className="flex-1 relative overflow-auto pt-4 p-4">
                        <div className="absolute top-0 right-4 bg-neutral-800 text-[10px] text-neutral-500 px-2 py-1 rounded-b">
                          EVIDENCE PREVIEW
                        </div>
