// C:\Users\s9khr\sasasa\ecommerce-platform\frontend\src\pages\LoginPage.jsx
...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // في حالة النجاح، التوجيه إلى لوحة التحكم
            navigate('/dashboard'); 

        } catch (err) {
            // عرض رسالة الخطأ
            const errorMessage = err.response?.data?.message || 'فشل تسجيل الدخول. يرجى التحقق من البريد وكلمة المرور.';
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-xl">
                <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">تسجيل الدخول</h2>
