...
3.  **Impact**: All existing Owner Sessions are invalidated. All export verifications prior to rotation require the _Old Key_ for verification (archive old keys securely!).
